...
Route::get('/vehicle/booking/detail2/{quotationId}', [CarBookingController::class, 'car_booking_quotation2', 'as' => 'car_booking_quotation2.index'])->name('car_booking_quotation2');
...
Route::get('/payment-thankyou', [CarBookingController::class, 'complete', 'as' => 'car_booking.complete'])->name('car_complete');
Route::get('/enquiry-thankyou', [CarBookingController::class, 'enquiry_complete', 'as' => 'car_booking.enquiry_complete'])->name('car_enquiry_complete');
