...
<body style="background-color: #f2fafc; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f2fafc;" width="100%">
        <tbody>
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #787771;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 19px; text-align: right; mso-line-height-alt: 16.8px;font-weight:bold;">
                                                                            TEJAS - {{$data->id}}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 10px; padding-right: 10px; vertical-align: top; padding-top: 15px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:15px;padding-left:10px;padding-right:10px;padding-top:25px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Name: <br/><br/><span
                                                                                style="color:#3098fe;"><strong>{{$data->name}}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            Email: <br/><br/><span
                                                                                style="color:#3098fe;"><strong>{{$data->email}}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            Phone: <br/><br/><span
                                                                                style="color:#3098fe;"><strong>{{$data->phone}}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="text-align:center;width:100%;">
                                                                <h1
                                                                    style="margin: 0; color: #555555; direction: ltr; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 23px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                                    <span class="tinyMce-placeholder">Trip Info</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span
                                                                                style="color:#3098fe;"><strong>
                                                                                @if($data->triptype_id==3)
                                                                                OutStation
                                                                                @elseif($data->triptype_id==4)
                                                                                Airport Ride
                                                                                @else
                                                                                Local Ride
                                                                                @endif  
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span
                                                                                style="color:#3098fe;"><strong>{{$data->pickup_address}}</strong></span>
                                                                        </p><br/>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span
                                                                                style="color:#424242;"><strong>{{date('d-m-Y',strtotime($data->from_date))}} {{$data->from_time}}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span
                                                                                style="color:#3098fe;"><strong>{{$data->to_city}}</strong></span>
                                                                        </p><br />
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span
                                                                                style="color:#424242;"><strong>{{date('d-m-Y',strtotime($data->to_date))}} {{$data->to_time}}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="column column-2"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-right:0px;padding-bottom:5px;padding-left:0px;padding-top:15px;">
                                                                <div></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #3098fe; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            Description</p>
                                                                    </div>
                    ...
                    @php 
                    if($data->triptype_id==3){
                        $details = $data->OutStation->getAmountArrayEmail($data->trip_distance, $data->from_date, $data->to_date);
                    }elseif($data->triptype_id==1 || $data->triptype_id==2){
                        $details = $data->LocalRide->getAmountArrayEmail();
                    }else{
                        $details = array();
                    }
                    @endphp
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-28"
                        role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    style="margin: 0; color: #555555; font-size: 23px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">
                                                                    <span class="tinyMce-placeholder">Note</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; mso-line-height-alt: 18px; color: #44464a; line-height: 1.5; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
                                                                            Integer eget nibh vel massa gravida
                                                                            ullamcorper. Sed a viverra ante. Nullam
                                                                            posuere pellentesque lectus, nec vehicula
                                                                            felis rutrum ac. Maecenas porta facilisis
                                                                            turpis, eget imperdiet purus.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-29"
                        role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-30"
                        role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    style="margin: 0; color: #555555; font-size: 23px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">
                                                                    <span class="tinyMce-placeholder">Terms &
                                                                        Condition</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
