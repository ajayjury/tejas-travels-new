        ...
        <tbody>
            <tr>
                <td>
                    ...
                    @php 
                    if($data->triptype_id==3){
                        $details = $vehicle->getAmountArrayEmail($data->trip_distance, $data->from_date, $data->to_date);
                    }elseif($data->triptype_id==1 || $data->triptype_id==2){
                        $details = $vehicle->getAmountArrayEmail();
                    }elseif($data->triptype_id==4){
                        $details = $vehicle->getAmountArrayEmail();
                    }else{
                        $details = array();
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            {{$notes->description_unformatted}}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
                                                                            {{$term->description_unformatted}}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
