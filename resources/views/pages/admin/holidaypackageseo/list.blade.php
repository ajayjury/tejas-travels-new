            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Holiday Package Seo</h4>
                    </div><!-- end card header -->
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href={{route('holidaypackageseo_create')}} type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <form  method="get" action="{{route('holidaypackageseo_view')}}">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="sort" data-sort="customer_name">Holiday Package</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            <td class="customer_name">{{$item->holidaypackage->name}}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('holidaypackageseo_display', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">View</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('holidaypackageseo_edit', $item->id)}}" class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('holidaypackageseo_image_view', $item->id)}}" class="btn btn-sm btn-warning edit-item-btn">Banner Images</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('holidaypackageseo_content_layout_view', $item->id)}}" class="btn btn-sm btn-primary edit-item-btn">Content Layout</a>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" onclick="deleteHandler('{{route('holidaypackageseo_delete', $item->id)}}')">Remove</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
