                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-6 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="question" id="question" value="{{$country->question}}">
                                        @error('question') 
                                ...
                                <div class="col-xxl-6 col-md-12">
                                    <div>
                                        ...
                                        <select class="form-control" name="position" id="position">
                                            ...
                                            <option value="{{$i}}" {{$country->position==$i ? 'selected' : ''}}>{{$i}}</option>
                                            @endfor
                                        </select>
                                        @error('position') 
                                            <div class="invalid-message">{{ $message }}</div>
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    <div id="termInput">
                                        ...
                                        <div id="editorabout">{!!$country->answer!!}</div>
                                        @error('about') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                        <input type="hidden" id="answer" name="answer">
                                        <input type="hidden" id="answer_formatted" name="answer_formatted">
                                    </div>
                                </div>
  ...
  .onSuccess(async (event) => {
    // event.target.submit();
      ...
      try {
        ...
        const response = await axios.post('{{route('faq_update', $country->id)}}', formData)
