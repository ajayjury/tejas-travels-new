                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('transporter_store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
  ...
  .onSuccess(async (event) => {
    ...
    const errorToast = (message) =>{
      ...
      try {
        ...
        const response = await axios.post('{{route('transporter_store')}}', formData)
