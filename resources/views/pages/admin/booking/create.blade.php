...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form id="countryForm" method="post" action="{{route('booking_store')}}" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <div id="editor_discount_notes"></div>
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <div id="editor_extra_charge_notes"></div>
...
<script type="text/javascript">
    ...
    function duplicate() {
        ...
        document.getElementsByName('payment_status[]')[count-1].value = "";
        document.getElementsByName('payment_mode[]')[count-1].value = "";
