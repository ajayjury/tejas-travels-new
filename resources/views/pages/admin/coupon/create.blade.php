...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form id="countryForm" method="post" action="{{route('coupon_store')}}" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="no_of_use" id="no_of_use" value="{{old('no_of_use')}}">
                                        @error('no_of_use') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="min_invoice_amount" id="min_invoice_amount" value="{{old('min_invoice_amount')}}">
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="max_discount" id="max_discount" value="{{old('max_discount')}}">
                                        @error('max_discount') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
...
@include('pages.admin.coupon._js_ridetype_select')
@include('pages.admin.coupon._js_customertype_select')
@include('pages.admin.coupon._js_usetype_select')
@include('pages.admin.coupon._js_discounttype_select')
@include('pages.admin.coupon._js_vehicletype_select')
  ...
  .onSuccess(async (event) => {
    // event.target.submit();
      ...
      try {
        ...
        const response = await axios.post('{{route('coupon_store')}}', formData)
