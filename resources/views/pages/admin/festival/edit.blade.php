                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('festival_update', $country->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
...
@include('pages.admin.festival._js_holidaytype_select_edit')
@include('pages.admin.festival._js_country_edit_select')
@include('pages.admin.festival._js_state_edit_select')
@include('pages.admin.festival._js_city_edit_select')
  ...
  .onSuccess(async (event) => {
    ...
    const errorToast = (message) =>{
      ...
      try {
        ...
        const response = await axios.post('{{route('festival_update', $country->id)}}', formData)
