                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href={{route('vehicletypeseo_image_create', $vehicleseotype_id)}} type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <form  method="get" action="{{route('vehicletypeseo_image_view', $vehicleseotype_id)}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('vehicletypeseo_image_display', [$item->vehicletypesseo_id, $item->id])}}" class="btn btn-sm btn-info edit-item-btn">View</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('vehicletypeseo_image_edit', [$item->vehicletypesseo_id, $item->id])}}" class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" onclick="deleteHandler('{{route('vehicletypeseo_image_delete', [$item->vehicletypesseo_id, $item->id])}}')">Remove</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
