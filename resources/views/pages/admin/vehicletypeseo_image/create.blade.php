...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <a href={{route('vehicletypeseo_image_view', $country->id)}} type="button" class="btn btn-dark add-btn" id="create-btn"><i class="ri-arrow-go-back-line align-bottom me-1"></i> Back</a>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('vehicletypeseo_image_store', $country->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
