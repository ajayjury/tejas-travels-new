                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('airport_store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
...
{{-- @include('pages.admin.cities.modal_create') --}}
...
@include('pages.admin.cities._js_city_select')
