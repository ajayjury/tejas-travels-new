...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <a href={{route('airport_view')}} type="button" class="btn btn-dark add-btn" id="create-btn"><i class="ri-arrow-go-back-line align-bottom me-1"></i> Back</a>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Airport</h4>
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('airport_update', $state->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="latitude" id="address-latitude" value="{{$state->latitude}}" readonly disabled>
                                        @error('latitude') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="longitude" id="address-longitude" value="{{$state->longitude}}" readonly disabled>
                                        @error('longitude') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
