            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Driver</h4>
                    </div><!-- end card header -->
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('transporter_driver_update', [$country->transporter_id, $country->id])}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
