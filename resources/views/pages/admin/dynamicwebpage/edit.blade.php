...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form id="countryForm" method="post" action="{{route('dynamicwebpage_update', $country->id)}}" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-12">
                                    <div>
                                        <label for="image" class="form-label">Banner Image (Dimension : 1280 x 700)</label>
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    <div id="termInput">
                                        ...
                                        <div id="editorabout">{!!$country->content!!}</div>
                                        @error('about') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="mt-4 mt-md-0">
                                        <div>
                                            <div class="form-check form-switch form-check-right mb-2">
                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckRightDisabled2" name="system_page" {{$country->system_page==1 ? 'checked' : ''}}>
  ...
  .onSuccess(async (event) => {
    // event.target.submit();
      ...
      try {
        ...
        const response = await axios.post('{{route('dynamicwebpage_update', $country->id)}}', formData)
