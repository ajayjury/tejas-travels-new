...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <a href={{route('enquiry_view')}} type="button" class="btn btn-dark add-btn" id="create-btn"><i class="ri-arrow-go-back-line align-bottom me-1"></i> Back</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                            ...
                                            <h5 class="fs-15 mb-0">{{$country->fname}} {{$country->lname}}</h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
