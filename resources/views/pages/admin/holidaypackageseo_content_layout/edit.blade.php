                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('holidaypackageseo_content_layout_update', [$country->holidaypackageseo_id, $country->id])}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
