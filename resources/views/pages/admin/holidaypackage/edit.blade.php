...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form id="countryForm" method="post" action="{{route('holidaypackage_update', $country->id)}}" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="price" id="price" value="{{$country->price}}">
                                        @error('price') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="days" id="days" value="{{$country->day}}">
                                        @error('days') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="nights" id="nights" value="{{$country->night}}">
                                        @error('nights') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    <div id="termInput">
                                        ...
                                        <div id="editorabout">{!!$country->about!!}</div>
                                        @error('about') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body"style="background-color: #d9d9d9;box-shadow:0px 0px 8px 2px #9f9f9f inset;" id="duplicateContentDiv">
                        ...
                        <div class="row gy-4" id="duplicate_{{$holidaypackagetourplan->id}}">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" name="day_name[]" value="{{$holidaypackagetourplan->day_name}}">
                                                        @error('day_name') 
                                                            <div class="invalid-message">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" name="title[]" value="{{$holidaypackagetourplan->title}}">
                                                        @error('title') 
                                                            <div class="invalid-message">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-xxl-12 col-md-12">
                                                    <div>
                                                        ...
                                                        <textarea name="desc[]" class="form-control" cols="30" rows="10">{!!$holidaypackagetourplan->description!!}</textarea>
                                                        @error('title') 
                                                            <div class="invalid-message">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                        ...
                        <div class="live-preview">
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-12">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="description1" onchange="descriptionInputChange()" value="1" name="default_description" {{$country->default_policy==1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="description1">
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="description2" onchange="descriptionInputChange()" value="2" name="default_description" {{$country->default_policy==2 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="description2">
                                            No
                                        </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="description3" onchange="descriptionInputChange()" value="3" name="default_description" {{$country->default_policy==3 ? 'checked' : ''}}>
                                    ...
                                    <div id="descriptionInput" style="display:none;">
                                        ...
                                        <div id="editordescription">{!!$country->policy!!}</div>
                                        @error('description') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
...
@include('pages.admin.holidaypackage._js_bookingtype_select_edit')
@include('pages.admin.holidaypackage._js_amenity_edit_select')
@include('pages.admin.holidaypackage._js_country_edit_select')
@include('pages.admin.holidaypackage._js_state_edit_select')
@include('pages.admin.holidaypackage._js_city_edit_select')
  ...
  .onSuccess(async (event) => {
    // event.target.submit();
      ...
      try {
        ...
        const response = await axios.post('{{route('holidaypackage_update', $country->id)}}', formData)
