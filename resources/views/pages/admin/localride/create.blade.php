                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="base_price" id="base_price" value="{{old('base_price')}}">
                                        @error('base_price') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="included_km" id="included_km" value="{{old('included_km')}}">
                                        @error('included_km') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="included_day" id="included_day" value="{{old('included_day')}}">
                                        @error('included_day') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="included_hr" id="included_hr" value="{{old('included_hr')}}">
                                        @error('included_hr') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="additional_price_per_km" id="additional_price_per_km" value="{{old('additional_price_per_km')}}">
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="additional_price_per_hr" id="additional_price_per_hr" value="{{old('additional_price_per_hr')}}">
