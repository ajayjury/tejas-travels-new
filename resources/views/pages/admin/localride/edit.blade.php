...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <a href={{route('localride_view')}} type="button" class="btn btn-dark add-btn" id="create-btn"><i class="ri-arrow-go-back-line align-bottom me-1"></i> Back</a>
            </div>
        </div>
        <form id="countryForm" method="post" action="{{route('localride_update', $country->id)}}" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Local Ride</h4>
                    </div><!-- end card header -->
                    <div class="card-body">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <select id="packagetype" name="packagetype"></select>
                                        @error('packagetype') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Regular Fare</h4>
                    </div><!-- end card header -->
                    <div class="card-body">
                        <div class="live-preview">
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        <label for="included_day" class="form-label">Included Day</label>
                                        <input type="text" class="form-control" name="included_day" id="included_day" value="{{$country->included_day}}">
                                        @error('included_day') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        <label for="included_hr" class="form-label">Included Hrs</label>
                                        <input type="text" class="form-control" name="included_hr" id="included_hr" value="{{$country->included_hr}}">
                                        @error('included_hr') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-12">
                                    <div>
                                        <label for="additional_price_per_hr" class="form-label">Additional Price Per Hrs</label>
                                        <input type="text" class="form-control" name="additional_price_per_hr" id="additional_price_per_hr" value="{{$country->additional_price_per_hr}}">
                                        @error('additional_price_per_hr') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-xxl-4 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="date" class="form-control" name="start_date[]" value="{{$specialfarelocalride->start_date ? $specialfarelocalride->start_date : date('Y-m-d')}}">
                                                        @error('start_date') 
                                                            <div class="invalid-message">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-xxl-4 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="date" class="form-control" name="end_date[]" value="{{$specialfarelocalride->end_date ? $specialfarelocalride->end_date : date('Y-m-d')}}">
                                                        @error('end_date') 
                                                            <div class="invalid-message">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-xxl-4 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" name="price[]" value="{{$specialfarelocalride->price ? $specialfarelocalride->price : '0.00'}}">
                                                        @error('price') 
                                                            <div class="invalid-message">{{ $message }}</div>
                                                        @enderror
                                                    </div>
