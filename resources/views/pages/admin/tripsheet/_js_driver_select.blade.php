...
const choicesDriver = new Choices('#driver', {
      silent: false,
      items: [],
      choices: [
        {
            ...
            @if(!$tripsheet)
            selected: {{empty(old('driver')) ? 'true' : 'false'}},
            @endif
            disabled: true,
        },
        @foreach($driver as $driver)
            {
                ...
                label: '{{$driver->name}}',
                @if($tripsheet)
                selected: {{($tripsheet->transporter_driver_id==$driver->id) ? 'true' : 'false'}},
                @endif
            },
        @endforeach
      ],
      ...
      // sorter: () => {...},
      placeholder: true,
      placeholderValue: 'Select a driver',
