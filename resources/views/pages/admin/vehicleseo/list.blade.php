            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Vehicle Seo</h4>
                    </div><!-- end card header -->
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href={{route('vehicleseo_create')}} type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <form  method="get" action="{{route('vehicleseo_view')}}">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            <td class="customer_name">@if($item->vehicle){{$item->vehicle->name}}@endif</td>
                                            <td class="customer_name">@if($item->state){{$item->state->name}}@endif</td>
                                            <td class="customer_name">@if($item->city){{$item->city->name}}@endif</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('vehicleseo_display', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">View</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('vehicleseo_preview', $item->id)}}" target="_blank" class="btn btn-sm btn-warning edit-item-btn">Preview</a>
                                                    </div>
                                                    <div class="edit">
