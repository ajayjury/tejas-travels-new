...
@include('includes.main.breadcrumb')
            ...
            <div class="row mt3">
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="x_slider_form_main_wrapper float_left x_slider_form_main_wrapper_ccb">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="x_slider_form_input_wrapper float_left">
													<h3>Offical Email Id</h3>
													<input type="email" placeholder="Enter Your Offical Email Id">
												</div>
											</div>
                                            <div class="col-md-12">
												<div class="x_slider_form_input_wrapper float_left">
                                            ...
                                            <div class="col-md-12">
												<div class="x_slider_form_input_wrapper float_left">
													...
													<input type="text" placeholder="Enter Your Office Location">
												</div>
											</div>
                                            <div class="col-md-12">
												<div class="x_slider_form_input_wrapper float_left">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
					<div class="x_carbooking_right_section_wrapper float_left">
						<div class="row">
                            <div class="col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12 full_width">
    ...
    <div class="x_offer_car_main_wrapper float_left padding_tb_100 bg-light-grey2">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="x_offer_car_heading_wrapper float_left">
						...
						<div class="owl-carousel screen nplr screen-loop">
							<div>
								<div class="card  valign-wrapper">
									...
									<div class="card-image">
										<img src="images/home/client_1.jpg" alt="img">
									</div>
									<!-- /Client's image -->
							...
							<div>
								<div class="card  valign-wrapper">
									<!-- Client's image -->
									<div class="card-image">
										<img src="images/home/client_2.jpg" alt="img">
									</div>
									<!-- /Client's image -->
									<div class="card-content center-align valign">
										<div class="testi_slide_star">
							...
							<div>
								<div class="card  valign-wrapper">
									<!-- Client's image -->
									<div class="card-image">
										<img src="images/home/client_3.jpg" alt="img">
									</div>
									<!-- /Client's image -->
									<div class="card-content center-align valign">
									<div class="testi_slide_star">
							...
							<div>
								<div class="card  valign-wrapper">
									<!-- Client's image -->
									<div class="card-image">
										<img src="images/home/client_4.jpg" alt="img">
									</div>
									<!-- /Client's image -->
									<div class="card-content center-align valign">
									<div class="testi_slide_star">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="x_book_logo_wrapper float_left">
						<img src="images/tejas-white-logo.png" alt="logo">
					</div>
				</div>
				<div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-justify mt2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                        </div>
                        <div class="col-md-6">
                            <img src="images/employee-transportation/img1.png" alt="car_img">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2 text-center">
                        <div class="icon-wrapper">
                            <i class="fa-solid fa-mask circle-icon"><span class="fix-editor">&nbsp;</span></i>
                        </div>
                        <h5 class="text-center mt10">Wear Mask</h5>
                    </div>
                    <div class="col-md-2 text-center">
                        <div class="icon-wrapper">
                            <i class="fa-solid fa-handshake-simple-slash circle-icon"><span class="fix-editor">&nbsp;</span></i>
                        </div>
                        <h5 class="mt10">Maintain Social Distance</h5>
                    </div>
                    <div class="col-md-2 text-center">
                        <div class="icon-wrapper">
                            <i class="fa-solid fa-pump-soap circle-icon"><span class="fix-editor">&nbsp;</span></i>
                        </div>
                        <h5 class="mt10">Carry Sanitizer</h5>
                    </div>
                    <div class="col-md-2 text-center">
                        <div class="icon-wrapper">
                            <i class="fa-solid fa-spa circle-icon"><span class="fix-editor">&nbsp;</span></i>
                        </div>
                        <h5 class="mt10">Peace of Mind</h5>
                    </div>
                    <div class="col-md-2 text-center">
                        <div class="icon-wrapper">
                            <i class="fa-solid fa-mask circle-icon"><span class="fix-editor">&nbsp;</span></i>
                    ...
                    <div class="col-md-2 text-center">
                        <div class="icon-wrapper">
                            <i class="fa-solid fa-check circle-icon"><span class="fix-editor">&nbsp;</span></i>
                        </div>
                        <h5 class="mt10">Guaranteed for Every Booking</h5>
                    </div>
