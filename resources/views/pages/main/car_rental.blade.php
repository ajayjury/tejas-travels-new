                ...
                <div class="col-md-12">
                    <div class="x_offer_tabs_wrapper">
                        <ul class="nav nav-tabs">
                            @foreach ($vehicletypes as $key => $value)
                                <li class="nav-item"> <a class="nav-link {{ $key == 0 && empty(Request::get('type')) || !strcasecmp($value->name,Request::get('type')) ? 'active' : '' }}" data-toggle="tab"
                    ...
                    <div class="tab-content">
                        @foreach ($vehicletypes as $key => $value)
                            ...
                            class="tab-pane  {{ ($key == 0 && empty(Request::get('type')) || !strcasecmp($value->name,Request::get('type')) ? 'active' : 'fade') }}">
                                <div class="row">
